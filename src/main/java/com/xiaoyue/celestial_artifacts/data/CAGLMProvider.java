...
public class CAGLMProvider extends GlobalLootModifierProvider {
	...
	public CAGLMProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> pvd) {
		super(output, pvd, CelestialArtifacts.MODID);
	}
	...
	public static void addInfo(BiConsumer<ItemStack, Component> cons) {
		...
		cons.accept(CAItems.DESIRE_ETCHING.asStack(), CALang.JEIInfo.CURSE.get(
				TextFacet.perc(CAModConfig.SERVER.materials.desireEtchingDropChance.get()),
				CatastropheScroll.Curses.DESIRE.title.get(),
				CALang.JEIInfo.DESIRE.get(CCLangData.entity(EntityType.WITHER),
						TextFacet.num(CAModConfig.SERVER.materials.desireEtchingLootingRequirement.get())
				)));

		cons.accept(CAItems.END_ETCHING.asStack(), CALang.JEIInfo.CURSE.get(
				TextFacet.perc(CAModConfig.SERVER.materials.endEtchingDropChance.get()),
				CatastropheScroll.Curses.END.title.get(),
				CALang.JEIInfo.END.get(CCLangData.entity(EntityType.WARDEN),
						TextFacet.num(CAModConfig.SERVER.materials.endEtchingEffectRequirement.get())
				)));

		cons.accept(CAItems.ORIGIN_ETCHING.asStack(), CALang.JEIInfo.CURSE.get(
				TextFacet.perc(CAModConfig.SERVER.materials.originEtchingDropChance.get()),
		...
		cons.accept(CAItems.LIFE_ETCHING.asStack(), CALang.JEIInfo.CURSE.get(
				TextFacet.perc(CAModConfig.SERVER.materials.lifeEtchingDropChance.get()),
				CatastropheScroll.Curses.LIFE.title.get(),
				CALang.JEIInfo.LIFE.get(
						TextFacet.num(CAModConfig.SERVER.materials.lifeEtchingHealthRequirement.get())
				)));

		cons.accept(CAItems.NIHILITY_ETCHING.asStack(), CALang.JEIInfo.CURSE.get(
				TextFacet.perc(CAModConfig.SERVER.materials.nihilityEtchingDropChance.get()),
		...
		cons.accept(CAItems.CHAOTIC_ETCHING.asStack(), CALang.JEIInfo.CURSE_BY.get(
				TextFacet.perc(CAModConfig.SERVER.materials.chaoticEtchingDropChance.get()),
		...
		cons.accept(CAItems.TRUTH_ETCHING.asStack(), CALang.JEIInfo.CURSE_BY.get(
				TextFacet.perc(CAModConfig.SERVER.materials.truthEtchingDropChance.get()),
				CCLangData.entity(EntityType.WITHER),
				CALang.JEIInfo.TRUTH.get()));

		cons.accept(CAItems.CHARMING_BRACELET.asStack(), CALang.JEIInfo.CHARMING.get(
				TextFacet.num(CAModConfig.SERVER.materials.charmingBraceletReputationRequirement.get()),
				TextFacet.perc(CAModConfig.SERVER.materials.charmingBraceletDropChance.get()),
		...
		cons.accept(CAItems.GUARDIAN_EYE.asStack(), CALang.JEIInfo.CURSE_DROP.get(
				...
				TextFacet.perc(CAModConfig.SERVER.materials.guardianEyeDropChance.get()),
		...
		cons.accept(CAItems.DEMON_CURSE.asStack(), CCLangData.AFTER_WITHER_DROP.get(
				...
				TextFacet.perc(CAModConfig.SERVER.materials.demonCurseDropChance.get()).setStyle(Style.EMPTY),
		...
		cons.accept(CAItems.TWISTED_HEART.asStack(), CALang.JEIInfo.WITHER_KILL.get(
				TextFacet.perc(CAModConfig.SERVER.materials.twistedHeartDropChance.get()),
				CCLangData.entity(EntityType.WITHER),
				CALang.JEIInfo.LIFE.get(TextFacet.num(CAModConfig.SERVER.materials.twistedHeartHealthRequirement.get()))));

		cons.accept(CAItems.TWISTED_BRAIN.asStack(), CALang.JEIInfo.WITHER_KILL.get(
				TextFacet.perc(CAModConfig.SERVER.materials.twistedBrainDropChance.get()),
				CCLangData.entity(EntityType.WITHER),
				CALang.JEIInfo.TRUTH.get()));
	...
	protected void start() {
		for (var e : CALootTableGen.values()) {
			if (e != CALootTableGen.FISHING_TREASURE) {
				add(e.id().location().getPath(), new AddLootTableModifier(e.id().location(),
						LootTableIdCondition.builder(e.target.location()).build()));
			} else {
				add(e.id().location().getPath(), new AddLootTableModifier(e.id().location(),
		...
		for (LootBoxEnum e : LootBoxEnum.values()) {
			add(e.id().getPath(), new FishingCooldownModifier(CAItems.TREASURE_HUNTER_NECKLACE.get(),
					e.box, IntConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.necklace.treasureHunterNecklaceCooldown),
					DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.necklace.treasureHunterNecklaceChance),
		...
		add("drops/desire_etching", new AddItemModifier(CAItems.DESIRE_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.desireEtchingDropChance),
				...
				IntConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.desireEtchingLootingRequirement))));
		add("drops/end_etching", new AddItemModifier(CAItems.END_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.endEtchingDropChance),
				CatastropheScroll.Curses.END.asCondition(),
				entityType(EntityType.WARDEN), new PlayerEffectCondition(MobEffectCategory.HARMFUL,
				IntConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.endEtchingEffectRequirement))));
		add("drops/origin_etching", new AddItemModifier(CAItems.ORIGIN_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.originEtchingDropChance),
				CatastropheScroll.Curses.ORIGIN.asCondition(),
				entityType(EntityType.ENDER_DRAGON), entity(EntityPredicate.Builder.entity()
				.located(new LocationPredicate.Builder().setY(MinMaxBounds.Doubles.atLeast(200))))));
		add("drops/life_etching", new AddItemModifier(CAItems.LIFE_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.lifeEtchingDropChance),
				CatastropheScroll.Curses.LIFE.asCondition(),
				new EntityHealthCondition(IntConfigValue.of(CAModConfig.SERVER.getPath(),
						CAModConfig.SERVER.materials.lifeEtchingHealthRequirement))));
		add("drops/nihility_etching", new AddItemModifier(CAItems.NIHILITY_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.nihilityEtchingDropChance),
		...
		add("drops/chaotic_etching", new AddItemModifier(CAItems.CHAOTIC_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.chaoticEtchingDropChance),
		...
		add("drops/truth_etching", new AddItemModifier(CAItems.TRUTH_ETCHING.get(), CAItems.NEBULA_CUBE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.truthEtchingDropChance),
		...
		add("drops/the_end_dust", new AddItemModifier(CAItems.THE_END_DUST.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.endDustDropChance),
		...
		add("drops/charming_bracelet", new AddItemModifier(CAItems.CHARMING_BRACELET.get(), Items.GOLD_INGOT,
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.charmingBraceletDropChance),
				new EnabledCondition(CAItems.CHARMING_BRACELET.get()), entityType(EntityType.VILLAGER),
				new PlayerStatCondition(PlayerStatCondition.Type.REPUTATION, IntConfigValue.of(CAModConfig.SERVER.getPath(),
						CAModConfig.SERVER.materials.charmingBraceletReputationRequirement))));
		add("drops/guardian_eye", new AddItemModifier(CAItems.GUARDIAN_EYE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.guardianEyeDropChance),
		...
		add("drops/demon_curse", new AddItemModifier(CAItems.DEMON_CURSE.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.demonCurseDropChance),
		...
		add("drops/twisted_heart", new AddItemModifier(CAItems.TWISTED_HEART.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.twistedHeartDropChance),
				new EnabledCondition(CAItems.TWISTED_HEART.get()),
				killer(EntityType.WITHER), new EntityHealthCondition(IntConfigValue.of(CAModConfig.SERVER.getPath(),
				CAModConfig.SERVER.materials.twistedHeartHealthRequirement))));
		add("drops/twisted_brain", new AddItemModifier(CAItems.TWISTED_BRAIN.get(),
				DoubleConfigValue.of(CAModConfig.SERVER.getPath(), CAModConfig.SERVER.materials.twistedBrainDropChance),
