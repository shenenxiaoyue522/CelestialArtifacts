 ...
 */
public record EffectFacet(Supplier<Holder<MobEffect>> eff, IntSupplier duration, IntSupplier amplifier, IntSupplier period)
		implements TickFacet, SingleLineText {

	public static EffectFacet of(Supplier<Holder<MobEffect>> eff, IntSupplier duration, IntSupplier amplifier, IntSupplier period) {
		return new EffectFacet(eff, duration, amplifier, period);
	}

	public static EffectFacet of(Supplier<Holder<MobEffect>> eff) {
		return of(eff, () -> 2, () -> 0, () -> 0);
	}

	public static EffectFacet of(Supplier<Holder<MobEffect>> eff, int duration, int amplifier) {
		return of(eff, () -> duration, () -> amplifier, () -> 0);
	}

	public static EffectFacet of(Supplier<Holder<MobEffect>> eff, IntSupplier duration, IntSupplier amplifier) {
		return of(eff, duration, amplifier, () -> 0);
	}
	...
	public void tick(LivingEntity entity, ItemStack stack) {
		...
		if (period.getAsInt() <= duration.getAsInt() || entity.tickCount % (period.getAsInt() * 20) == 0) {
			EffectUtil.refreshEffect(entity, get(), entity);
		}
	}
