...
public class HolyNecklace implements SingleLineText, HealFeature {
	...
	private static int cooldownFactor() {
		return CAModConfig.SERVER.necklace.holyNecklaceCooldown.get();
	}

	private static MobEffectInstance eff() {
		return new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, CAModConfig.SERVER.necklace.holyNecklaceDuration.get() * 20, 0);
	}
