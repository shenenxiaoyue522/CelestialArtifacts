...
public class SkywalkerScroll extends BaseTickingToken
	...
	public void trigger(ServerPlayer player) {
		...
		if (player.isCrouching()) {
			...
			player.level().playSound(null, player.getOnPos(), SoundEvents.UI_BUTTON_CLICK.get(), SoundSource.PLAYERS, 1f, 1f);
			...
			player.level().playSound(null, player.getOnPos(), SoundEvents.CHORUS_FRUIT_TELEPORT, SoundSource.PLAYERS, 1f, 1f);
		}
	}
