...
public class SakuraHairpin extends BaseTickingToken {
	...
	private static double critBonus() {
		return CAModConfig.SERVER.head.sakuraHairpinCritBonusFromLuck.get();
	}
	...
	private AttrAdder crit() {
		return AttrAdder.of("sakura_hairpin", L2DamageTracker.CRIT_RATE::holder,
				AttributeModifier.Operation.ADD_VALUE, sakura_hairpin_bonus);
	}
